...
<body>
    ...
    $sql_Ore9 = "SELECT Nome_attivita, Giorno_settimana FROM attivita WHERE Ore_attivita = '9:00:00' AND `id_brancaEs2` = 2";
    $result_Ore9 = $conn->query($sql_Ore9);

    $sql_Ore11 = "SELECT Nome_attivita, Giorno_settimana FROM attivita WHERE Ore_attivita = '11:00:00' AND `id_brancaEs2` = 2";
    $result_Ore11 = $conn->query($sql_Ore11);

    $sql_Ore15 = "SELECT Nome_attivita, Giorno_settimana FROM attivita WHERE Ore_attivita = '15:00:00' AND `id_brancaEs2` = 2";
    $result_Ore15 = $conn->query($sql_Ore15);

    $sql_Ore18 = "SELECT Nome_attivita, Giorno_settimana FROM attivita WHERE Ore_attivita = '18:00:00' AND `id_brancaEs2` = 2";
